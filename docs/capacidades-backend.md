...
| `ofrecimientos` | **No** | **Sí** | "Tengo algo para donar". Falta listarlos |
...
| `solicitudes` | No | **Sí** (sin UI) | Unirse a un centro. Implementado, sin botón todavía |
| `transportes` | No | **Sí** (sin UI) | Programar transporte. Implementado, sin pantalla |
